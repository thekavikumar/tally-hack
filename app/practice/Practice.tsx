  ...
  return (
    <div className='flex justify-center'>
        <div className=' w-5/6 h-4/6 min-h-fit min-w-fit outline-dashed outline-1 rounded-lg p-4 flex flex-col justify-center items-center'>
            ...
            <br/>
            <div className=' border outline-1 rounded-md w-4/5 bg-slate-300 dark:bg-black p-5 flex justify-evenly'>
              <input
                type='text-area' id='practice-input'  placeholder={x} className=' dark:text-white min-w-full min-h-full text-black bg-inherit outline-none'
              />
            </div>
